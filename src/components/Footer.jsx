export default function Footer() {
    return (
        <footer className="bg-[#0a0c0d] text-[#9199a1] py-8 text-[13px] font-sans">
            <div className="max-w-316 w-full mx-auto px-4 flex flex-col md:flex-row">
                <div className="flex-[0_0_64px] mb-8 md:mb-0 mr-4">
                    <svg aria-hidden="true" className="w-8 h-9.25" viewBox="0 0 32 37" fill="none">
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end mt-auto text-[11px] pt-8 md:pt-16 xl:pt-24">
                        <div className="flex flex-col gap-2 w-full">
                            ...
                            <p>This is a literal clone ! Do not take anything seriously ! And get some humour to undestand this !</p>
                        </div>
                    </div>
                </div>
            </div>
